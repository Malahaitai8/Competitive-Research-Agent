...
from ..competitive_sources import enrich_sub_queries_with_official_sources
import logging
...
async def generate_sub_queries(
    ...
    **kwargs
    ...
    sub_queries = _normalize_sub_queries(json_repair.loads(response), query)
    max_total_queries = min((cfg.max_iterations or 3) + 2, 6)
    return enrich_sub_queries_with_official_sources(
        query,
        sub_queries,
        max_total=max_total_queries,
        max_official_queries=2,
    )
