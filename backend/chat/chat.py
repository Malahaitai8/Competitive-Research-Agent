...
class ChatAgentWithMemory:
    ...
    async def chat(self, messages, websocket=None):
        ...
        try:
            ...
            You must include citations to your answer based on the report whenever the report contains relevant sources.
            If the user asks to improve, rewrite, expand, or refine the report, you may help by proposing edits,
            rewritten sections, or an improved version of the requested part. Do not claim that the saved report has
            already been changed unless an external system explicitly applies the edit.
