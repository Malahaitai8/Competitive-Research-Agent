...
from server.competitive_research import collect_competitive_metadata, save_competitive_analysis
from gpt_researcher.utils.enum import Tone
from chat.chat import ChatAgentWithMemory

from server.report_store import ReportStore

# Local JSON persistence is used by default; set DATABASE_URL to use MySQL.
...
async def write_report(research_request: ResearchRequest, research_id: str = None):
    ...
    agent_metadata = collect_competitive_metadata(report_information[1] if research_request.report_type != "multi_agents" else None)
    ...
    if research_request.report_type != "multi_agents":
        ...
        response = {
            ...
            "competitive_analysis_path": competitive_analysis_path,
